...
public class KThread {
	...
	public KThread(Runnable target) {
		this();
		this.target = target;
		//join queue constructor to cover both parts of the if statement
		joinQueue = ThreadedKernel.scheduler.newThreadQueue(true);
		boolean intStatus = Machine.interrupt().disable();
		joinQueue.acquire(this);
		Machine.interrupt().restore(intStatus);
	...
	protected static KThread getCurrentThread() {
		return currentThread;
	}
	...
	public static String getCurrentThreadStats() {
		...
		String outString =  "\nCurrent Thread Statistics:\n\tName: " + currentThread.name + "\n\tStatus: " + currentThread.status
				+ "\n\tPriority: " + ThreadedKernel.scheduler.getPriority() + "\n\tEffectivePriority: "
				+ThreadedKernel.scheduler.getEffectivePriority();
		Machine.interrupt().restore(intStatus);
		return outString;
	}

	public static int getReadyQueueID()
	{
		PriorityScheduler.PriorityQueue rq = (PriorityScheduler.PriorityQueue)readyQueue;
		return rq.queueID;
	}
	...
	public static void finish() {
		...
		/**this is where the queue for joing threads is poped**/
	...
	//that returns the ID of a thread
	public int getID(){
		return this.id;
	}
	//Testing Helper Method
	//that returns the status of a thread
